...
function header(){
  ...
  return '<div class="header"><a href="#/">Доставка напитков Кировский СПб — 18+</a><div class="nav"><a href="#/" style="color:#fff">Каталог</a><a href="#/districts" style="color:#fff">Районы</a><a href="#/track/" style="color:#fff">Заказ</a><a href="#/cart" style="color:#fff">🛒<span class="cart-badge" id="cb">'+c+'</span></a></div></div>';
}
